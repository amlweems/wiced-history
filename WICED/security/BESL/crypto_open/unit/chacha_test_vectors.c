...
/* ========================================= */
/* Test vectors for the ChaCha stream cipher */
/*                                           */
/* Generated by gen_chacha_test_vectors      */
/* ========================================= */

#include "chacha_test_vectors.h"

const chacha_vector_t chacha_test_vectors[] =
{

    { /* TC1: All zero key and IV, Vector 0 : 128 byte key, 8 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        },
        128, /* Key Length */
        { /* Initial Value (8 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        },
        8, /* Rounds */
        { /* Keystream Block ( 64 bytes) */
    ...
    { /* TC1: All zero key and IV, Vector 1 : 128 byte key, 12 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC1: All zero key and IV, Vector 2 : 128 byte key, 20 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC1: All zero key and IV, Vector 3 : 256 byte key, 8 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC1: All zero key and IV, Vector 4 : 256 byte key, 12 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC1: All zero key and IV, Vector 5 : 256 byte key, 20 rounds */
        "TC1: All zero key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 0 : 128 byte key, 8 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 1 : 128 byte key, 12 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (128 bytes) */
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 2 : 128 byte key, 20 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (128 bytes) */
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 3 : 256 byte key, 8 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (256 bytes) */
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 4 : 256 byte key, 12 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (256 bytes) */
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC2: Single bit in key set. All zero IV, Vector 5 : 256 byte key, 20 rounds */
        "TC2: Single bit in key set. All zero IV", /* Description */
        { /* Key (256 bytes) */
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 0 : 128 byte key, 8 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        },
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 1 : 128 byte key, 12 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 2 : 128 byte key, 20 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 3 : 256 byte key, 8 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 4 : 256 byte key, 12 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC3: Single bit in IV set. All zero key, Vector 5 : 256 byte key, 20 rounds */
        "TC3: Single bit in IV set. All zero key", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    { /* TC4: All bits in key and IV are set, Vector 0 : 128 byte key, 8 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC4: All bits in key and IV are set, Vector 1 : 128 byte key, 12 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (128 bytes) */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    { /* TC4: All bits in key and IV are set, Vector 2 : 128 byte key, 20 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (128 bytes) */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    { /* TC4: All bits in key and IV are set, Vector 3 : 256 byte key, 8 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (256 bytes) */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    { /* TC4: All bits in key and IV are set, Vector 4 : 256 byte key, 12 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (256 bytes) */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    { /* TC4: All bits in key and IV are set, Vector 5 : 256 byte key, 20 rounds */
        "TC4: All bits in key and IV are set", /* Description */
        { /* Key (256 bytes) */
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    { /* TC5: Every even bit set in key and IV, Vector 0 : 128 byte key, 8 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC5: Every even bit set in key and IV, Vector 1 : 128 byte key, 12 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ...
    { /* TC5: Every even bit set in key and IV, Vector 2 : 128 byte key, 20 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ...
    { /* TC5: Every even bit set in key and IV, Vector 3 : 256 byte key, 8 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ...
    { /* TC5: Every even bit set in key and IV, Vector 4 : 256 byte key, 12 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ...
    { /* TC5: Every even bit set in key and IV, Vector 5 : 256 byte key, 20 rounds */
        "TC5: Every even bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
            0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 0 : 128 byte key, 8 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 1 : 128 byte key, 12 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 2 : 128 byte key, 20 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (128 bytes) */
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 3 : 256 byte key, 8 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 4 : 256 byte key, 12 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    ...
    { /* TC6: Every odd bit set in key and IV, Vector 5 : 256 byte key, 20 rounds */
        "TC6: Every odd bit set in key and IV", /* Description */
        { /* Key (256 bytes) */
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 0 : 128 byte key, 8 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 1 : 128 byte key, 12 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 2 : 128 byte key, 20 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (128 bytes) */
            0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 3 : 256 byte key, 8 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 4 : 256 byte key, 12 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
    ...
    { /* TC7: Sequence patterns in key and IV, Vector 5 : 256 byte key, 20 rounds */
        "TC7: Sequence patterns in key and IV", /* Description */
        { /* Key (256 bytes) */
            0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 0 : 128 byte key, 8 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (128 bytes) */
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 1 : 128 byte key, 12 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (128 bytes) */
            0xc4, 0x6e, 0xc1, 0xb1, 0x8c, 0xe8, 0xa8, 0x78,
            0x72, 0x5a, 0x37, 0xe7, 0x80, 0xdf, 0xb7, 0x35,
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 2 : 128 byte key, 20 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (128 bytes) */
            0xc4, 0x6e, 0xc1, 0xb1, 0x8c, 0xe8, 0xa8, 0x78,
            0x72, 0x5a, 0x37, 0xe7, 0x80, 0xdf, 0xb7, 0x35,
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 3 : 256 byte key, 8 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (256 bytes) */
            0xc4, 0x6e, 0xc1, 0xb1, 0x8c, 0xe8, 0xa8, 0x78,
            0x72, 0x5a, 0x37, 0xe7, 0x80, 0xdf, 0xb7, 0x35,
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 4 : 256 byte key, 12 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (256 bytes) */
            0xc4, 0x6e, 0xc1, 0xb1, 0x8c, 0xe8, 0xa8, 0x78,
            0x72, 0x5a, 0x37, 0xe7, 0x80, 0xdf, 0xb7, 0x35,
    ...
    { /* TC8: key: 'All your base are belong to us!, IV: 'IETF2013', Vector 5 : 256 byte key, 20 rounds */
        "TC8: key: 'All your base are belong to us!, IV: 'IETF2013'", /* Description */
        { /* Key (256 bytes) */
            0xc4, 0x6e, 0xc1, 0xb1, 0x8c, 0xe8, 0xa8, 0x78,
            0x72, 0x5a, 0x37, 0xe7, 0x80, 0xdf, 0xb7, 0x35,
...
const int chacha_test_vectors_count = sizeof(chacha_test_vectors) / sizeof(chacha_vector_t);
