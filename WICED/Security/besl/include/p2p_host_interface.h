...
extern p2p_discovered_device_t* p2p_host_find_device(p2p_workspace_t* workspace, besl_mac_t* mac);
...
extern besl_result_t            p2p_process_probe_request( p2p_workspace_t* workspace, uint8_t* data, uint32_t data_length );
extern void                     p2p_process_action_frame ( p2p_workspace_t* workspace, p2p_discovered_device_t* device, uint8_t* data, uint32_t data_length );
extern p2p_discovered_device_t* p2p_find_device          ( p2p_workspace_t* workspace, besl_mac_t* mac);
extern besl_result_t            p2p_process_new_device_data( p2p_workspace_t* workspace, p2p_discovered_device_t* device, uint8_t* data, uint16_t data_length );
