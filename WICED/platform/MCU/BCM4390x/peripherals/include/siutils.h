...
struct si_pub {
	...
	bool	pci_pr32414;		/* XXX whether 32414 WAR applies to the chip */
...
extern bool si_iscoreup_wrapper(void *wrapper);
...
extern void si_core_reset_set_wrapper(void *wrapper, uint32 bits, uint32 resetbits);
extern void si_core_reset_clear_wrapper(void *wrapper, uint32 bits);
extern void si_core_reset_wrapper(void *wrapper, uint32 bits, uint32 resetbits);
...
#else
#define si_eci(sih) 0
static INLINE void * si_eci_init(si_t *sih) { (void)sih; return NULL;}
#define si_eci_notify_bt(sih, type, val)  (0)
#define si_seci(sih) 0
#define si_seci_upd(sih, a)	do {} while (0)
static INLINE void * si_seci_init(si_t *sih, uint8 use_seci) { (void)sih; (void)use_seci; return NULL;}
static INLINE void * si_gci_init(si_t *sih) { (void)sih; return NULL;}
...
#if !defined(DONGLEBUILD) || defined(BCMHOSTVARS)
