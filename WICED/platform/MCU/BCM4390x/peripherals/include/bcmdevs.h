 ...
 *
 * $Id: bcmdevs.h 478955 2014-05-19 22:41:07Z sshih $
 */
...
#define BCM43457_D11AC_ID	0x43bd		/* 43457 802.11ac dualband device */
#define BCM43457_D11AC2G_ID	0x43be		/* 43457 802.11ac 2.4G device */
#define BCM43457_D11AC5G_ID	0x43bf		/* 43457 802.11ac 5G device */
...
#define BCM43567_D11AC_ID	0x43d3
#define BCM43567_D11AC2G_ID	0x43d4
#define BCM43567_D11AC5G_ID	0x43d5
...
/* Unreleased PCI Device IDs */
#define BCM43229_D11N_ID	0x435d		/* 43229 802.11n dualband device */
#define BCM43229_D11N2G_ID	0x435e		/* 43229 802.11n 2.4GHz device */
#define BCM43229_D11N5G_ID	0x435c		/* 43229 802.11n 5GHz device (same as 43228?) */

#define BCM4337_D11AC_ID	0x43a6
#define BCM4337_D11AC2G_ID	0x43a7
#define BCM4337_D11AC5G_ID	0x43a8
...
#define BCM4358_D11AC_ID	0x43e9		/* 4358 802.11ac dualband id */
#define BCM4358_D11AC2G_ID	0x43ea		/* 4358 802.11ac 2.4Ghz band id */
#define BCM4358_D11AC5G_ID	0x43eb		/* 4358 802.11ac 5Ghz band id */
...
#ifdef UNRELEASEDCHIP
#define BCM4337_CHIP_ID		0x4337          /* 4337 chipcommon chipid */
...
#define BCM43455_CHIP_ID    43357       /* 43455 chipcommon chipid */
#endif /* UNRELEASEDCHIP */
...
/* XXX 4706L corresponding to BCM53001 */
...
#define BFL_DIS_256QAM		0x00000008
					/* XXX: for 4360, this bit is to disable 256QAM support */
...
/* XXX BFL_FASTPWR and BFL_UCPWRCTL_MININDX are non-overlaping features and use the same bit */
#define BFL_FASTPWR		0x08000000  /* XXX Fast switch/antenna powerup (no POR WAR) */
...
#define BFL2_4313_RADIOREG	0x10000000 /* 4313 radio register change (PR82977) need to match */
									   /*  board rework */
...
#define BFL_SROM11_GAINBOOSTA01	0x20000000  /* 5g Gainboost for core0 and core1. */
				/* For ACPHY/43602Ax for boosting Hi Pwr router */
#define BFL2_SROM11_APLL_WAR	0x00000002  /* Flag to implement alternative A-band PLL settings */
#define BFL2_SROM11_GAINBOOST_CORE2 0x00000100  /* Boosts core 2 by 2dB for targeted for MCH5 */
...
#define BFL4_SROM12_4dBPAD      0x1   /* To distinguigh between normal and 4dB pad board */
...
#define BCM94331PCIEBT4_SSID      0x0527	/* XXX BRCM Build of X19 */
#define BCM94331HM_SSID           0x0574
#define BCM94331PCIEDUAL_SSID     0x059B	/* XXX BRCM Build of X12 */
#define BCM94331MCH5_SSID         0x05A9
#define BCM94331CS_SSID           0x05C6	/* XXX BRCM Build of X29 */
#define BCM94331CD_SSID           0x05DA	/* XXX BRCM Build of X33 */
