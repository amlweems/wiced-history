...
typedef volatile struct {
	...
	/* GSIO interface 1 (corerev >= 49) */
	uint32	gsio1ctrl;		/* 0x480 */
	uint32	gsio1address;		/* 0x484 */
	uint32	gsio1data;		/* 0x488 */
	uint32	gsio1clkdiv;		/* 0x48C */

	/* GSIO interface 2 (corerev >= 49) */
	uint32	gsio2ctrl;		/* 0x490 */
	uint32	gsio2address;		/* 0x494 */
	uint32	gsio2data;		/* 0x498 */
	uint32	gsio2clkdiv;		/* 0x49C */

	/* GSIO interface 3 (corerev >= 49) */
	uint32	gsio3ctrl;		/* 0x4A0 */
	uint32	gsio3address;		/* 0x4A4 */
	uint32	gsio3data;		/* 0x4A8 */
	uint32	gsio3clkdiv;		/* 0x4AC */
	uint32	PAD[20];
...
#define	PCTLEX_FTE_MASK		(1 << 0)
#define	PCTLEX_FTE_SHIFT	0
...
/* GSIOCtrl.GsioOp (GO) */
#define GSIO_GO_SHIFT               0
#define GSIO_GO_MASK                0x000000FF
#define GSIO_GO_BITS                8

/* GSIOCtrl.GsioCode (GC) */
#define GSIO_GC_I2C_SOURCE_FROMOP   0x00000100
#define GSIO_GC_I2C_SOURCE_FROMDATA 0x00000200
#define GSIO_GC_SPI_OPCODE_AND_1DATA_IN  0x00000000
#define GSIO_GC_SPI_OPCODE_AND_NOA_NOD_DATA_IN  0x00000100
#define GSIO_GC_SPI_OPCODE_AND_NOA_NOD_DATA_IO  0x00000200
#define GSIO_GC_SPI_OPCODE_AND_NOA_NOX_NOD_DATA_IO  0x00000300
#define GSIO_GC_SPI_NOD_DATA_IO  0x00000400
#define GSIO_GC_SHIFT               8
#define GSIO_GC_MASK                0x00000700
#define GSIO_GC_BITS                3

/* GSIOCtrl.NumberOfAddress (NoA) */
#define GSIO_NOA_I2C_START_NONE     0x00000000
#define GSIO_NOA_I2C_START_7BITS    0x00001000
#define GSIO_NOA_I2C_START_10BITS   0x00002000
#define GSIO_NOA_SHIFT              12
#define GSIO_NOA_MASK               0x00003000
#define GSIO_NOA_BITS               2

/* GSIOCtrl.NumberOfWaitCycles (NoX) */
#define GSIO_NOX_SHIFT              (14)
#define GSIO_NOX_BITS               (2)
#define GSIO_NOX_MASK               (((1<<GSIO_NOX_BITS)-1) << GSIO_NOX_SHIFT)
#define GSIO_NOX_SPI_WAIT_8_CYCLES  (0 << GSIO_NOX_SHIFT)
#define GSIO_NOX_SPI_WAIT_16_CYCLES (1 << GSIO_NOX_SHIFT)
#define GSIO_NOX_SPI_WAIT_24_CYCLES (2 << GSIO_NOX_SHIFT)
#define GSIO_NOX_SPI_WAIT_32_CYCLES (3 << GSIO_NOX_SHIFT)

/* GSIOCtrl.NumberofDataBytes (NoD) */
#define GSIO_NOD_SHIFT              (16)
#define GSIO_NOD_BITS               (2)
#define GSIO_NOD_MASK               (((1<<GSIO_NOD_BITS)-1) << GSIO_NOD_SHIFT)
#define GSIO_NOD_1                  (0 << GSIO_NOD_SHIFT)
#define GSIO_NOD_2                  (1 << GSIO_NOD_SHIFT)
#define GSIO_NOD_3                  (2 << GSIO_NOD_SHIFT)
#define GSIO_NOD_4                  (3 << GSIO_NOD_SHIFT)

/* GSIOCtrl.Read */
#define GSIO_READ_I2C_READ          0x00040000
#define GSIO_READ_I2C_WRITE         0x00000000
#define GSIO_READ_SHIFT             18
#define GSIO_READ_MASK              0x00040000
#define GSIO_READ_BITS              1

/* GSIOCtrl.NoAck */
#define GSIO_NOACK_I2C_SEND_ACK     0x00000000
#define GSIO_NOACK_I2C_NO_ACK       0x00080000
#define GSIO_NOACK_I2C_IGNORE_ACK   0x00080000
#define GSIO_NOACK_I2C_CHECK_ACK    0x00000000
#define GSIO_NOACK_SHIFT            19
#define GSIO_NOACK_MASK             0x00080000
#define GSIO_NOACK_BITS             1

/* GSIOCtrl.RxAck */
#define GSIO_RXACK_I2C_ACK          0x00000000
#define GSIO_RXACK_I2C_NACK         0x00100000
#define GSIO_RXACK_SHIFT            20
#define GSIO_RXACK_MASK             0x00100000
#define GSIO_RXACK_BITS             1

/* GSIOCtrl.GsioGo (GG) */
#define GSIO_GG_SHIFT               (21)
#define GSIO_GG_BITS                (1)
#define GSIO_GG_MASK                (((1<<GSIO_GG_BITS)-1) << GSIO_GG_SHIFT)
#define GSIO_GG_I2C_GENERATE_STOP   (1 << GSIO_GG_SHIFT)
#define GSIO_GG_SPI_CHIP_SELECT     (1 << GSIO_GG_SHIFT)

/* GSIOCtrl.Endianness */
#define GSIO_ENDIANNESS_LITTLE      0x00000000
#define GSIO_ENDIANNESS_BIG         0x00400000
#define GSIO_ENDIANNESS_SHIFT       22
#define GSIO_ENDIANNESS_MASK        0x00400000
#define GSIO_ENDIANNESS_BITS        1

/* GSIOCtrl.Error */
#define GSIO_ERROR                  0x00800000
#define GSIO_ERROR_SHIFT            23
#define GSIO_ERROR_MASK             0x00800000
#define GSIO_ERROR_BITS             1

/* GSIOCtrl.GsioMode (GM) */
#define GSIO_GM_SPI                 0x00000000
#define GSIO_GM_I2C                 0x40000000
#define GSIO_GM_SHIFT               30
#define GSIO_GM_MASK                0x40000000
#define GSIO_GM_BITS                1

/* GSIOCtrl.StartBusy (SB) */
#define GSIO_SB_SHIFT               (31)
#define GSIO_SB_BITS                (1)
#define GSIO_SB_MASK                (((1<<GSIO_SB_BITS)-1) << GSIO_SB_SHIFT)
#define GSIO_SB_BUSY                (1 << GSIO_SB_SHIFT)


/* GSIOClkDiv.GSIODiv (GD) */
#define GSIO_GD_SHIFT               4
#define GSIO_GD_MASK                0x001FFFF0
#define GSIO_GD_BITS                17
...
#define UART_FCR_TX_FIFO_RESET 0x04	/* FIFO control register bit controlling Tx FIFO Reset */
#define UART_FCR_RX_FIFO_RESET 0x02	/* FIFO control register bit controlling Rx FIFO Reset */
...
#ifdef BCMINTERNAL
#define CST4330_NOT_STRAP_SDIOD_SEL	0x00000008
#endif
...
#define RES4345_MACPHY_CLKAVAIL	30
...
/* LTECX: ltecxmux mask */
#define LTECX_MUX_MODE_SHIFT	0
#define LTECX_MUX_MODE_MASK		((0xF) << LTECX_MUX_MODE_SHIFT)
#define LTECX_MUX_GPIOCFG_SHIFT 4
#define LTECX_MUX_GPIOCFG_MASK	((0xF) << LTECX_MUX_GPIOCFG_SHIFT)
#define LTECX_MUX_FSYNC_SHIFT	8
#define LTECX_MUX_FSYNC_MASK	((0xF) << LTECX_MUX_FSYNC_SHIFT)
#define LTECX_MUX_LTERX_SHIFT	12
#define LTECX_MUX_LTERX_MASK	((0xF) << LTECX_MUX_LTERX_SHIFT)
#define LTECX_MUX_LTETX_SHIFT	16
#define LTECX_MUX_LTETX_MASK	((0xF) << LTECX_MUX_LTETX_SHIFT)
#define LTECX_MUX_WLPRIO_SHIFT	20
#define LTECX_MUX_WLPRIO_MASK	((0xF) << LTECX_MUX_WLPRIO_SHIFT)
/* LTECX: ltecxmux MODE */
#define LTECX_MUX_MODE_WCI2		0x0
#define LTECX_MUX_MODE_GPIO		0x1
#define LTECX_MUX_MODE_NOLTECX	0xF

/* LTECX: ltecxmux GPIO config */
#define LTECX_MUX_CONFIG_GPIO2345	0x0
#define LTECX_MUX_CONFIG_GPIO89AB	0x1
#define LTECX_MUX_GPIOMASK_SHIFT	16
/* LTECX: ltecxmux SECI GPIO config */
#define LTECX_MUX_WCI2_UARTI_SHIFT	4
#define LTECX_MUX_WCI2_UARTI_MASK	((0xF) << LTECX_MUX_WCI2_UARTI_SHIFT)
#define LTECX_MUX_WCI2_UARTO_SHIFT	8
#define LTECX_MUX_WCI2_UARTO_MASK	((0xF) << LTECX_MUX_WCI2_UARTO_SHIFT)
#define LTECX_MUX_WCI2_FNSELI_SHIFT	12
#define LTECX_MUX_WCI2_FNSELI_MASK	((0xF) << LTECX_MUX_WCI2_FNSELI_SHIFT)
#define LTECX_MUX_WCI2_FNSELO_SHIFT	16
#define LTECX_MUX_WCI2_FNSELO_MASK	((0xF) << LTECX_MUX_WCI2_FNSELO_SHIFT)
