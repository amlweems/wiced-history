...
typedef struct etc_info {
	...
	uint32		loopbk;		/* loopback override mode */
...
/* Loopback modes */
#define LOOPBACK_MODE_NONE	0	/* no Loopback */
#define LOOPBACK_MODE_MAC_MII	1	/* loopback the packet at MAC (GMII/MII loopback) */
#define LOOPBACK_MODE_MAC_LINE	2	/* loopback the packet at MAC (Line Loopback i.e. MAC FIFO side loopback) */
#define LOOPBACK_MODE_DMA	3	/* loopback the packet at the DMA engine */
#define LOOPBACK_MODE_PHY	4	/* loopback the packet by PHY */
