 ...
 *
 * $Id: sdio.h 416730 2013-08-06 09:33:19Z danielko $
 */
...
#define SDIOD_CCCR_UHSI_SUPPORT	    SDIOD_CCCR_UHS_I
#define SDIOD_CCCR_DRIVER_STRENGTH  SDIOD_CCCR_DRIVE
#define SDIOD_CCCR_INTR_EXTN        SDIOD_CCCR_INTEXT
