...
//#endif
 ...
 {
     /* Check for the common flagsas a minimal test - do not just count on this to be correct!!! */
      if ( (dct_version != NULL) &&
                                                       ...
                                                       platform_dct_p2p_config_t* p2p_config_source)
{
    ...
    {
        default:
            /* no p2p config struct here - nothing to do */
            break;
        case DCT_BOOTLOADER_SDK_3_5_1:
        case DCT_BOOTLOADER_SDK_3_5_2:
        case DCT_BOOTLOADER_SDK_3_6_0:
                                                        ...
                                                        bootloader_dct_ota2_config_t* ota2_config_source)
{
    ...
    {
        default:
            /* no ota2 config struct here - nothing to do */
            break;
        case DCT_BOOTLOADER_SDK_3_5_2:
        case DCT_BOOTLOADER_SDK_3_6_0:
        case DCT_BOOTLOADER_SDK_3_6_1:
