...
const platform_pin_mapping_t gpio_mapping[] =
{
    ...
    [WICED_GPIO_AUTH_RST]    = {GPIOB, 2, RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_AUTH_SCL]    = {GPIOB, 10, RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_AUTH_SDA]    = {GPIOB, 11, RCC_AHB1Periph_GPIOB},
...
const platform_adc_mapping_t adc_mapping[] =
{
    ...
    [WICED_ADC_3] = {ADC1, ADC_Channel_3, RCC_APB2Periph_ADC1, 1, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_30]},
};
...
{
    [WICED_PWM_1]  = {TIM4, 1, RCC_APB1Periph_TIM4, GPIO_AF_TIM4, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_10]},
    [WICED_PWM_2]  = {TIM4, 2, RCC_APB1Periph_TIM4, GPIO_AF_TIM4, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_11]},
...
const platform_i2c_mapping_t i2c_mapping[] =
{
    ...
    {
        .i2c = I2C2,
        .pin_scl                 = &gpio_mapping[WICED_GPIO_AUTH_SCL],
        .pin_sda                 = &gpio_mapping[WICED_GPIO_AUTH_SDA],
