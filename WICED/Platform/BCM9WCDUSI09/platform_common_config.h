 ...
 * The CPU Clock Frequency (CPU_CLOCK_HZ) is independently defined in <WICED-SDK>/Wiced/Platform/BCM9WCDUSI09/BCM9WCDUSI09.mk
 */
...
#error WICED_WLAN_POWERSAVE_CLOCK_IS_MCO is unsupported for BCM9WCDUSI09 platform

#else

#define WL_32K_OUT_BANK        GPIOB
#define WL_32K_OUT_PIN         1
#define WL_32K_OUT_BANK_CLK    RCC_AHB1Periph_GPIOB
