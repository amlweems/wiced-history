 ...
 * A full pin definition is provided in <WICED-SDK>/include/platforms/BCMWCDUSI09/platform.h
 */
const platform_pin_mapping_t gpio_mapping[] =
{
    ...
    [WICED_GPIO_11] = {GPIOA, 13,  RCC_AHB1Periph_GPIOA},
    [WICED_GPIO_12] = {GPIOA, 14,  RCC_AHB1Periph_GPIOA},
    [WICED_GPIO_13] = {GPIOA, 15,  RCC_AHB1Periph_GPIOA},
    [WICED_GPIO_14] = {GPIOB,  3,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_15] = {GPIOB,  4,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_16] = {GPIOB,  5,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_17] = {GPIOB,  6,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_18] = {GPIOB,  7,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_19] = {GPIOB, 14,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_20] = {GPIOB, 15,  RCC_AHB1Periph_GPIOB},
    [WICED_GPIO_21] = {GPIOC,  2,  RCC_AHB1Periph_GPIOC},
    [WICED_GPIO_22] = {GPIOC,  3,  RCC_AHB1Periph_GPIOC},
    [WICED_GPIO_23] = {GPIOC,  5,  RCC_AHB1Periph_GPIOC},
    [WICED_GPIO_24] = {GPIOC,  7,  RCC_AHB1Periph_GPIOC},
...
{
    [WICED_PWM_1]  = {TIM4, 1, RCC_APB1Periph_TIM4, GPIO_AF_TIM4, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_17]},
    [WICED_PWM_2]  = {TIM4, 2, RCC_APB1Periph_TIM4, GPIO_AF_TIM4, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_18]},
    ...
    [WICED_PWM_WLAN_POWERSAVE_CLOCK] = {TIM8, 3, RCC_APB2Periph_TIM8, GPIO_AF_TIM8, (platform_pin_mapping_t*)&gpio_mapping[WICED_GPIO_WLAN_POWERSAVE_CLOCK] },
