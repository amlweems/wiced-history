 ...
 * The CPU Clock Frequency (CPU_CLOCK_HZ) is independently defined in <WICED-SDK>/Wiced/Platform/BCM943362WCD6/BCM943362WCD6.mk
 */
...
#define WL_REG_ON_BANK_CLK      RCC_AHB1Periph_GPIOB
...
/* SPI Slave pin definitions */
#define SPI_CLK_DATA_GPIO_BANK         GPIOA
#define SPI_CLK_GPIO_PIN               GPIO_Pin_5
#define SPI_MISO_GPIO_PIN              GPIO_Pin_6
#define SPI_MOSI_GPIO_PIN              GPIO_Pin_7
#define SPI_CLK_GPIO_PIN_SRC           GPIO_PinSource5
#define SPI_MISO_GPIO_PIN_SRC          GPIO_PinSource6
#define SPI_MOSI_GPIO_PIN_SRC          GPIO_PinSource7
