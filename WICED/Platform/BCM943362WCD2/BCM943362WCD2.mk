...
NAME := Platform_BCM943362WCD2_$(RTOS)
...
GLOBAL_INCLUDES  := . \
                    ../include \
                    ../../../include/platforms/BCM943362WCD2


$(NAME)_COMPONENTS := common/ARM_Cortex_M3/STM32F1xx
...
GLOBAL_DEFINES += CPU_CLOCK_HZ=72000000
GLOBAL_DEFINES += APP_NAME=$$(SLASH_QUOTE_START)$(APP)$$(SLASH_QUOTE_END)
GLOBAL_DEFINES += PLATFORM_STM32_VOLTAGE_2V7_TO_3V6

#STM32F10x doesnt support internal weak pull ups- ull downs when a gpio pin is operating in alternate function mode hence the pull-ups inside WLAN chip must be used
GLOBAL_DEFINES += WICED_USE_WLAN_SDIO_PULLUPS
...
ifeq ($(NETWORK),LwIP)
GLOBAL_DEFINES += PBUF_POOL_TX_SIZE=4
GLOBAL_DEFINES += PBUF_POOL_RX_SIZE=4
endif
endif
endif
