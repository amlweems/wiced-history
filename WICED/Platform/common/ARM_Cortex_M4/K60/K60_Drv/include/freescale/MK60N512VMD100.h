...
#include <stdint.h>
#include "k60_cortex_interface.h"
...
#define SPI_CTAR_REG(base,index2)                ((base)->ctar.CTAR[index2])
#define SPI_CTAR_SLAVE_REG(base,index2)          ((base)->ctar.CTAR_SLAVE[index2])
#define SPI_SR_REG(base)                         ((base)->SR)
#define SPI_RSER_REG(base)                       ((base)->RSER)
#define SPI_PUSHR_REG(base)                      ((base)->pushr.PUSHR)
#define SPI_PUSHR_SLAVE_REG(base)                ((base)->pushr.PUSHR_SLAVE)
...
#define SPI0_BASE_VAL                            (0x4002C000u)
#define SPI0_BASE_PTR                            ((SPI_MemMapPtr)SPI0_BASE_VAL)
/*! Peripheral SPI1 base pointer */
#define SPI1_BASE_VAL                            (0x4002D000u)
#define SPI1_BASE_PTR                            ((SPI_MemMapPtr)SPI1_BASE_VAL)
/*! Peripheral SPI2 base pointer */
#define SPI2_BASE_VAL                            (0x400AC000u)
#define SPI2_BASE_PTR                            ((SPI_MemMapPtr)SPI2_BASE_VAL)
