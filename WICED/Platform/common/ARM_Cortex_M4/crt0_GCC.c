...
void _start( void )
{
    ...
    *SCB_VTOR_ADDRESS = (unsigned long) &link_interrupt_vectors_location;
    ...
    {
        memcpy( &link_run_from_ram_code_ram_location, &link_run_from_ram_code_flash_location, link_run_from_ram_code_size );
    }
