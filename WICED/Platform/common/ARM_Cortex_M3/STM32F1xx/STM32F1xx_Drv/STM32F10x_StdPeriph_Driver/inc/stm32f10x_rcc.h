...
extern void RCC_HSEConfig(uint32_t RCC_HSE);
extern ErrorStatus RCC_WaitForHSEStartUp(void);
extern void RCC_AdjustHSICalibrationValue(uint8_t HSICalibrationValue);
extern void RCC_HSICmd(FunctionalState NewState);
extern void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul);
extern void RCC_PLLCmd(FunctionalState NewState);
...
extern void RCC_SYSCLKConfig(uint32_t RCC_SYSCLKSource);
extern uint8_t RCC_GetSYSCLKSource(void);
extern void RCC_HCLKConfig(uint32_t RCC_SYSCLK);
extern void RCC_PCLK1Config(uint32_t RCC_HCLK);
extern void RCC_PCLK2Config(uint32_t RCC_HCLK);
extern void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState);

#ifndef STM32F10X_CL
 extern void RCC_USBCLKConfig(uint32_t RCC_USBCLKSource);
#else
 void RCC_OTGFSCLKConfig(uint32_t RCC_OTGFSCLKSource);
#endif /* STM32F10X_CL */ 

extern void RCC_ADCCLKConfig(uint32_t RCC_PCLK2);
...
extern void RCC_LSEConfig(uint8_t RCC_LSE);
extern void RCC_LSICmd(FunctionalState NewState);
extern void RCC_RTCCLKConfig(uint32_t RCC_RTCCLKSource);
extern void RCC_RTCCLKCmd(FunctionalState NewState);
extern void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks);
extern void RCC_AHBPeriphClockCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState);
...
#ifdef STM32F10X_CL
extern void RCC_AHBPeriphResetCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState);
#endif /* STM32F10X_CL */ 
...
extern void RCC_BackupResetCmd(FunctionalState NewState);
extern void RCC_ClockSecuritySystemCmd(FunctionalState NewState);
extern void RCC_MCOConfig(uint8_t RCC_MCO);
extern FlagStatus RCC_GetFlagStatus(uint8_t RCC_FLAG);
extern void RCC_ClearFlag(void);
extern ITStatus RCC_GetITStatus(uint8_t RCC_IT);
extern void RCC_ClearITPendingBit(uint8_t RCC_IT);
