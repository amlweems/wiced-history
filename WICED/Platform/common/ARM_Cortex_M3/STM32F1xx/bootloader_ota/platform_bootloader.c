...
#define PLATFORM_APP_START_PAGE      16
#define PLATFORM_APP_END_PAGE        255

/* stack pointer for an application will we set to the highest possible sram address */
...
{
   return platform_erase_flash( PLATFORM_APP_START_PAGE, PLATFORM_APP_END_PAGE );
}
