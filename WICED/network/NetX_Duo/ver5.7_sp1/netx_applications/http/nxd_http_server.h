...
UINT        _nxe_http_server_content_get_extended(NX_HTTP_SERVER *server_ptr, NX_PACKET *packet_ptr, ULONG byte_offset, CHAR *destination_ptr, UINT destination_size, UINT *actual_size);
UINT        _nx_http_server_content_length_get_extended(NX_PACKET *packet_ptr, ULONG *length);
UINT        _nxe_http_server_content_length_get_extended(NX_PACKET *packet_ptr, ULONG *length);
