...
/*  11-23-2009     Yuxin Zhou               Added NX_IPSEC_MAX_HEADER_SIZE*/
/*                                            that allows max IPsec header*/
/*                                            header size when allocating */
/*                                            packets, resulting in       */ 
/*                                            version 5.4                 */ 
/*                                            resulting in version 5.4    */
/*  06-01-2010     Yuxin Zhou               Added IPv6 Path MTU discovery,*/
/*                                            added support for TCP fast  */
...
/*                                            an API to support multihome,*/ 
/*                                            added IPsec support, added  */
/*                                            new APIs for TCP window     */
/*                                            scaling, per-socket keep-   */
/*                                            alive, TCP state change     */
/*                                            callback, resulting in      */
/*                                            version 5.6                 */
/*  01-31-2012     Yuxin Zhou               Modified comment(s), moved    */
/*                                            IPsec error code into       */ 
/*                                            nx_ipsec.h, removed tunnel  */
/*                                            end points information from */
/*                                            the address selector, added */
/*                                            the IPv6 disable service,   */
/*                                            added DAD status notify,    */
/*                                            added APIs that allow IPv6  */ 
/*                                            stateless address autoconfig*/
/*                                            to be disabled at run time, */
...
/*                                            for handling an incoming TCP*/  
/*                                            SYN messages, before the    */ 
/*                                            connection is accepted,     */
/*                                            added multicast support,    */ 
/*                                            resulting in version 5.6-sp3*/
/*                                                                        */ 
/**************************************************************************/ 
...
#define __NETXDUO_MAJOR_VERSION__ 5
#define __NETXDUO_MINOR_VERSION__ 6
...
#define NX_CRYPTO_MAX_IV_SIZE_IN_BITS 128
#endif /* NX_CRYPTO_MAX_IV_SIZE_IN_BYTES */

/* Define the IPsec header size.  The space reserved here is good for ESP header and possiblly IPv4/v6 header in tunnel mode. */
#ifdef FEATURE_NX_IPV6
#define NX_IPSEC_MAX_HEADER_SIZE (((NX_CRYPTO_MAX_IV_SIZE_IN_BITS + 7) / 8) + 16 + 40)
#else /* !FEATURE_NX_IPV6 */
#define NX_IPSEC_MAX_HEADER_SIZE (((NX_CRYPTO_MAX_IV_SIZE_IN_BITS + 7) / 8) + 12 + 20)
...
#define NXDUO_DESTINATION_TABLE_SIZE  NX_DESTINATION_TABLE_SIZE 
#endif

#ifndef NXDUO_DESTINATION_TABLE_SIZE
#define NXDUO_DESTINATION_TABLE_SIZE 8
#ifndef NX_DESTIANTION_TABLE_SIZE
#define NX_DESTINATION_TABLE_SIZE NXDUO_DESTINATION_TABLE_SIZE 
#endif
#endif

/* Define the maximum ICMPv6 Duplicate Address Detect Transmit .  */
#ifdef NX_DUP_ADDR_DETECT_TRANSMITS  
#define NXDUO_DUP_ADDR_DETECT_TRANSMITS NX_DUP_ADDR_DETECT_TRANSMITS
#endif

#ifndef NXDUO_DUP_ADDR_DETECT_TRANSMITS
#define NXDUO_DUP_ADDR_DETECT_TRANSMITS 3
#ifndef NX_DUP_ADDR_DETECT_TRANSMITS
#define NX_DUP_ADDR_DETECT_TRANSMITS NXDUO_DUP_ADDR_DETECT_TRANSMITS 
#endif
#endif
...
#define NX_PROTOCOL_NEXT_HEADER_ICMPV6          58
...
/* By default NetX host is an IGMPv2 host.  By uncommenting this option, NetX
   reverts back to IGMPv1 only. */
...
#define NX_PARAMETER_ERROR          0x55
...
typedef  struct NX_PACKET_STRUCT
{
    ...
    ULONG       nx_packet_reassembly_time;  /* Time stamp for measuring the number of seconds a
                                               ...
                                               out value is reached (60 seconds) packets of the
                                               same FRAG ID are released. */
    ...
    */
...
#ifdef FEATURE_NX_IPV6
    /* Destination address for the packet, in host byte order. */
    ULONG       nx_packet_ipv6_dest_addr[4]; 

    /* Local interface address to use for transmission, in host byte order */
    ULONG       nx_packet_ipv6_src_addr[4];  

    /* Point to the interface IPv6 address structure.  On transmit path, this is */
    /* the address to use as source address. On receive path, this is the */
    /* address through which the packet is received.   */
    struct NXD_IPV6_ADDRESS_STRUCT *nx_packet_ipv6_addr;
    ...
    /* quick refernece to the IP header, in case there are optional headers. 
       This field is only used during the process of incoming packet.  
    */
    UCHAR       *nx_packet_ip_header; 

#ifdef NX_IPSEC_ENABLE

    VOID *nx_packet_ipsec_egress_sa;
#endif /* NX_IPSEC_ENABLE */
} NX_PACKET;
...
#ifdef FEATURE_NX_IPV6
    struct NXD_IPV6_ADDRESS_STRUCT *nx_udp_socket_ipv6_addr;
#endif /* FEATURE_NX_IPV6 */
} NX_UDP_SOCKET;
...
typedef struct NX_TCP_SOCKET_STRUCT
{
    ...
    /* Define the state of retransmit.  */
...
#define nx_ip_additional_link_info     nx_ip_interface[0].nx_interface_additional_link_info
...
#endif /* NX_FEATURE_RAW_PACKET_FILTER */
    ...
    VOID        (*nx_ipv6_address_change_notify)(struct NX_IP_STRUCT *, UINT, UINT, UINT, ULONG*);
#endif /* NX_IPV6_ADDRESS_CHANGE_NOTIFY_ENABL */
#endif /* FEATURE_NX_IPV6 */
    ...
    /* Define the ICMPv6 router advertisement process routine. */
...
#define nxd_icmp_interface_ping                 _nxd_icmp_interface_ping
#define nxd_ip_raw_packet_interface_send        _nxd_ip_raw_packet_interface_send
...
#define nxd_udp_socket_interface_send           _nxd_udp_socket_interface_send 
#define nxd_udp_socket_send                     _nxd_udp_socket_send 
#define nxd_udp_source_extract                  _nxd_udp_source_extract

#ifdef FEATURE_NX_IPV6
/* 
   nxd_ipv6_global_address_get and nxd_ipv6_global_address_set were removed with the NetX Duo 5.4
   release. The following macro is provided for backward compatibility.
*/
#define nxd_ipv6_global_address_set(i,a,p)      _nxd_ipv6_address_set(i,0,a,p,NX_NULL)
...
#define nxd_ipv6_linklocal_address_set(i, a)    _nxd_ipv6_address_set(i, 0, a, 10, NX_NULL)
...
#ifdef NX_IPV6_MULTICAST_ENABLE
#define nxd_multicast_interface_join            _nxd_multicast_interface_join
#define nxd_multicast_interface_leave           _nxd_multicast_interface_leave
#endif /* NX_IPV6_MULTICAST_ENABLE */
...
#define nxd_icmp_interface_ping                 _nxde_icmp_interface_ping
...
#define nxd_udp_socket_interface_send           _nxde_udp_socket_interface_send 

#ifdef FEATURE_NX_IPV6
/* 
   nxd_ipv6_global_address_get and nxd_ipv6_global_address_set were removed since NetX Duo 5.4
   The following macro is provided for backward compatibility.
*/
#define nxd_ipv6_global_address_set(i,a,p)      _nxde_ipv6_address_set(i,0,a,p,NX_NULL)
...
#define nx_ip_raw_packet_interface_send(i,p,d,f,t,l,s) _nxe_ip_raw_packet_interface_send(i,&p,d,f,t,l,s)
#define nxd_ip_raw_packet_interface_send        _nxde_ip_raw_packet_interface_send
...
#define nxd_ipv6_linklocal_address_set(i,a)     _nxde_ipv6_address_set(i, 0, a, 10, NX_NULL)
...
#ifdef NX_IPV6_MULTICAST_ENABLE
#define nxd_multicast_interface_join            _nxde_multicast_interface_join
#define nxd_multicast_interface_leave           _nxde_multicast_interface_leave
#endif /* NX_IPV6_MULTICAST_ENABLE */
...
UINT    nxd_icmp_interface_ping(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, UINT source_index, CHAR *data_ptr, ULONG data_size,
                                NX_PACKET **response_ptr, ULONG wait_option);
...
UINT    _nxde_udp_socket_interface_send(NX_UDP_SOCKET *socket_ptr, NX_PACKET *packet_ptr, NXD_ADDRESS *ip_address, UINT port, UINT interface_index);
...
UINT    _nxd_udp_socket_interface_send(NX_UDP_SOCKET *socket_ptr, NX_PACKET *packet_ptr, NXD_ADDRESS *ip_address, UINT port, UINT interface_index);
...
UINT    nx_icmp_interface_ping6(NX_IP *ip_ptr, NXD_ADDRESS *dest_ip_address, CHAR *data_ptr, ULONG data_size,UINT address_index, NX_PACKET **response_ptr, ULONG wait_option);
#endif
...
#ifndef NX_DISABLE_ERROR_CHECKING
UINT    _nxe_ip_raw_packet_interface_send(NX_IP *ip_ptr, NX_PACKET **packet_ptr_ptr, ULONG destination_ip, UINT if_index, ULONG type_of_service);
UINT    _nxe_ip_raw_packet_send(NX_IP *ip_ptr, NX_PACKET **packet_ptr_ptr, ULONG destination_ip, ULONG type_of_service);
UINT    _nxde_ip_raw_packet_interface_send(NX_IP *ip_ptr, NX_PACKET *packet_ptr, NXD_ADDRESS *destination_ip, UINT if_index, ULONG protocol, UINT ttl, ULONG tos);

#else
UINT    _nx_ip_raw_packet_interface_send(NX_IP *ip_ptr, NX_PACKET *packet_ptr, ULONG destination_ip, UINT if_index, ULONG type_of_service);
UINT    _nx_ip_raw_packet_send(NX_IP *ip_ptr, NX_PACKET *packet_ptr, ULONG destination_ip, ULONG type_of_service);
UINT    _nxd_ip_raw_packet_interface_send(NX_IP *ip_ptr, NX_PACKET *packet_ptr, NXD_ADDRESS *destination_ip, UINT if_index, ULONG protocol, UINT ttl, ULONG tos);

#endif /* NX_DISABLE_ERROR_CHECKING */


#ifndef NX_DISABLE_ERROR_CHECKING
UINT    _nxde_ip_raw_packet_send(NX_IP *ip_ptr, NX_PACKET **packet_ptr_ptr, NXD_ADDRESS *destination_ip, UINT if_index, ULONG protocol, UINT ttl, ULONG tos);
#else /* NX_DISABLE_ERROR_CHECKING */
...
#ifdef FEATURE_NX_IPV6
UINT    nxd_ipv6_address_get(NX_IP *ip_ptr, UINT address_index, NXD_ADDRESS *ip_address, ULONG *prefix_length, UINT *if_index);
UINT    nxd_ipv6_address_set(NX_IP *ip_ptr, UINT if_index, NXD_ADDRESS *ip_address, ULONG prefix_length, UINT *address_index);
UINT    nxd_ipv6_address_delete(NX_IP *ip_ptr, UINT address_index);
UINT    nxd_ipv6_default_router_add(NX_IP *ip_ptr, NXD_ADDRESS *router_addr,  ULONG router_lifetime, UINT if_index);
UINT    nxd_ipv6_default_router_delete(NX_IP *ip_ptr, NXD_ADDRESS *router_addr);
UINT    nxd_ipv6_default_router_get(NX_IP *ip_ptr, UINT if_index, NXD_ADDRESS *router_addr, ULONG *router_lifetime, ULONG *prefix_length);
UINT    nxd_nd_cache_invalidate(NX_IP *ip_ptr);
UINT    nxd_nd_cache_entry_set(NX_IP *ip_ptr, ULONG *dest_ip, UINT if_index, char*mac);
UINT    nxd_nd_cache_entry_delete(NX_IP *ip_ptr, ULONG *dest_ip);
UINT    nxd_nd_cache_ip_address_find(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, ULONG physical_msw, ULONG physical_lsw, UINT *if_index);
UINT    nxd_nd_cache_hardware_address_find(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, ULONG *physical_msw, ULONG *physical_lsw, UINT *if_index);
...
#ifdef NX_IPV6_MULTICAST_ENABLE
UINT    nxd_multicast_interface_join(NX_IP *ip_ptr, NXD_ADDRESS *group_address, UINT nx_interface_index);
UINT    nxd_multicast_interface_leave(NX_IP *ip_ptr, NXD_ADDRESS *group_address, UINT nx_interface_index);
#endif /* NX_IPV6_MULTICAST_ENABLE */
...
UINT    nxd_tcp_client_socket_connect(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *server_ip, UINT server_port, ULONG wait_option);
...
UINT    _nx_udp_socket_interface_send(NX_UDP_SOCKET *socket_ptr, NX_PACKET *packet_ptr, ULONG ip_address, UINT port, UINT address_index);

#endif
UINT    nxd_udp_packet_info_extract(NX_PACKET *packet_ptr, NXD_ADDRESS *ip_address, UINT *protocol, UINT *port, UINT *interface_index);
UINT    nx_udp_socket_unbind(NX_UDP_SOCKET *socket_ptr);
UINT    nx_udp_source_extract(NX_PACKET *packet_ptr, ULONG *ip_address, UINT *port);
UINT    nxd_ip_raw_packet_interface_send(NX_IP *ip_ptr, NX_PACKET *packet_ptr, NXD_ADDRESS *destination_ip, UINT if_index, ULONG protocol, UINT ttl, ULONG tos);
