...
UINT  _nxd_ipv6_address_get(NX_IP *ip_ptr, UINT address_index, NXD_ADDRESS *ip_address, ULONG *prefix_length, UINT *if_index);
UINT  _nxd_ipv6_address_set(NX_IP *ip_ptr, UINT if_index, NXD_ADDRESS *ip_address, ULONG prefix_length, UINT *address_index);
...
UINT  _nxd_ipv6_default_router_add(NX_IP *ip_ptr, NXD_ADDRESS *router_addr, ULONG router_lifetime, UINT if_index);
UINT  _nxd_ipv6_default_router_delete(NX_IP *ip_ptr, NXD_ADDRESS *router_address);
UINT  _nxd_ipv6_default_router_get(NX_IP *ip_ptr, UINT if_index, NXD_ADDRESS *router_addr, ULONG *router_lifetime, ULONG *prefix_length);
