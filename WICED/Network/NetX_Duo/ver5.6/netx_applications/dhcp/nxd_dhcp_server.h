...
/* The DHCP client needs to support multi homing if
...
UINT        _nx_dhcp_server_extract_information(NX_DHCP_SERVER *dhcp_ptr, NX_DHCP_CLIENT **dhcp_client_ptr, NX_PACKET *packet_ptr, UINT iface_index);
...
VOID        _nx_dhcp_server_store_data(UCHAR *data, UINT size, ULONG value);
