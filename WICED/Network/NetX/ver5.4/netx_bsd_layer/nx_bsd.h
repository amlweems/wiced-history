...
/*                                                                        */ 
/*  03-01-2009     William E. Lamie         Initial Version 5.3           */ 
/*  09-11-2009     William E. Lamie         Modified comment(s), added    */ 
/*                                            logic to handle             */ 
/*                                            FD_SETSIZE not evenly       */ 
/*                                            divisible by 32, and        */ 
/*                                            changed ERROR constant to   */ 
/*                                            NX_SOC_ERROR, and changed   */ 
/*                                            OK constant to NX_SOC_OK,   */ 
/*                                            resulting in version 5.4    */ 
/*  04-10-2010     Janet Christiansen       Modified comment(s),          */ 
...
#ifdef NX_BSD_INHERIT_LISTENER_SOCKET_SETTINGS 
...
#define NX_PACKET_OFFSET_ERROR              0x50
#endif
...
#define     NX_BSD_THREAD_PRIORITY  3
...
UINT nx_bsd_set_socket_disconnect_complete_notify(VOID (*nx_bsd_tcp_disconnect_complete_notify)(INT sockID));
UINT nx_bsd_set_socket_establish_notify(VOID (*bsd_tcp_establish_notify)(NX_TCP_SOCKET *socket_ptr));
