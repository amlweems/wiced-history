 ...
 *          WICED_ERROR;
 */
wiced_result_t wiced_ssdp_internal_mcast_start( wiced_ssdp_internal_t*  internal )
{
    ...
    /* Create a UDP socket */
    if (wiced_udp_create_socket(&internal->mcast_udp_socket, internal->mcast_port, WICED_STA_INTERFACE) != WICED_SUCCESS)
    {
