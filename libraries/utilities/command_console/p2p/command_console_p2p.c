...
int p2p_set_go_intent( int argc, char* argv[] )
{
    ...
    if ( argc == 2 )
    {
        ...
        if ( intent <= 15 )
        {
            p2p_workspace.group_owner_intent = intent;
        }
        else
        {
...
int p2p_set_listen_channel( int argc, char* argv[] )
{
    ...
    if ( argc == 2 )
    {
        ...
        {
            p2p_workspace.listen_channel.channel = channel;
        }
        else
        {
...
int p2p_set_operating_channel( int argc, char* argv[] )
{
    ...
    if ( argc == 2 )
    {
        ...
        {
            p2p_workspace.operating_channel.channel = channel;
        }
        else
        {
...
int p2p_set_go_pbc_mode_support( int argc, char* argv[] )
{
    ...
    if ( argc == 2 )
    {
        ...
        if ( allow_pbc_mode == 1 )
        {
            p2p_workspace.allowed_configuration_methods |= PUSH_BUTTON;
        }
        else
        {
            p2p_workspace.allowed_configuration_methods &= (~PUSH_BUTTON);
        }
        if ( p2p_workspace.allowed_configuration_methods & PUSH_BUTTON )
        {
