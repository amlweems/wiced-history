...
#define FX_INITIAL_DATE                 0x36F2          /* 07-18-2007 */
...
typedef struct FX_DIR_ENTRY_STRUCT
{
    ...
    ULONG               fx_dir_entry_file_size;                             /* Size of the file in bytes                         */ 
    ULONG               fx_dir_entry_log_sector;                            /* Logical sector of this directory entry            */ 
    ...
    ULONG               fx_dir_entry_last_search_log_sector;                /* Last logical sector searched                      */ 
...
UINT        fx_directory_attributes_read(FX_MEDIA *media_ptr, const CHAR *directory_name, UINT *attributes_ptr);
UINT        fx_directory_attributes_set(FX_MEDIA *media_ptr, const CHAR *directory_name, UINT attributes);
UINT        fx_directory_create(FX_MEDIA *media_ptr, const CHAR *directory_name);
UINT        fx_directory_default_get(FX_MEDIA *media_ptr, CHAR **return_path_name);
UINT        fx_directory_default_set(FX_MEDIA *media_ptr, const CHAR *new_path_name);
UINT        fx_directory_delete(FX_MEDIA *media_ptr, const CHAR *directory_name);
...
UINT        fx_directory_information_get(FX_MEDIA *media_ptr, const CHAR *directory_name, UINT *attributes, ULONG *size,
...
UINT        fx_directory_name_test(FX_MEDIA *media_ptr, const CHAR *directory_name);
...
UINT        fx_directory_next_full_entry_find(FX_MEDIA *media_ptr, CHAR *directory_name, UINT *attributes,
                ULONG *size, UINT *year, UINT *month, UINT *day, UINT *hour, UINT *minute, UINT *second);
UINT        fx_directory_rename(FX_MEDIA *media_ptr, const CHAR *old_directory_name, const CHAR *new_directory_name);
...
UINT        fx_file_attributes_read(FX_MEDIA *media_ptr, const CHAR *file_name, UINT *attributes_ptr);
UINT        fx_file_attributes_set(FX_MEDIA *media_ptr, const CHAR *file_name, UINT attributes);
UINT        fx_file_best_effort_allocate(FX_FILE *file_ptr, ULONG size, ULONG *actual_size_allocated);
UINT        fx_file_close(FX_FILE *file_ptr);
UINT        fx_file_create(FX_MEDIA *media_ptr, const CHAR *file_name);
UINT        fx_file_date_time_set(FX_MEDIA *media_ptr, const CHAR *file_name,
                UINT year, UINT month, UINT day, UINT hour, UINT minute, UINT second);
UINT        fx_file_delete(FX_MEDIA *media_ptr, const CHAR *file_name);
#ifdef FX_DISABLE_ERROR_CHECKING
UINT        _fx_file_open(FX_MEDIA *media_ptr, FX_FILE *file_ptr, const CHAR *file_name,
                UINT open_type);
#else
UINT        _fxe_file_open(FX_MEDIA *media_ptr, FX_FILE *file_ptr, const CHAR *file_name,
...
UINT        fx_file_rename(FX_MEDIA *media_ptr, const CHAR *old_file_name, const CHAR *new_file_name);
...
UINT        fx_file_write(FX_FILE *file_ptr, const VOID *buffer_ptr, ULONG size);
...
UINT        fx_media_format(FX_MEDIA *media_ptr, VOID (*driver)(FX_MEDIA *media), VOID *driver_info_ptr, UCHAR *memory_ptr, UINT memory_size,
                const CHAR *volume_name, UINT number_of_fats, UINT directory_entries, UINT hidden_sectors,
