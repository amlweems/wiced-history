...
/**
 * @file Apollo buffer manager routines.
 */
...
#define VALIDATE_POOL_HANDLE(x)                                                             \
    if (!(x))                                                                               \
    {                                                                                       \
        apollo_log_msg(APOLLO_LOG_ERR, "invalid media data buffer pool handle (NULL)\r\n"); \
        return APOLLO_BUFMGR_INVALID_HANDLE;                                                \
    }
...
#define APOLLO_BUFMGR_WAIT_INFINITE        WICED_WAIT_FOREVER
...
#define APOLLO_BUFMGR_FLAG_AU_START        (1 << 0) /* Buffer starts an access unit         */
#define APOLLO_BUFMGR_FLAG_AU_END          (1 << 1) /* Buffer terminates an access unit     */
#define APOLLO_BUFMGR_FLAG_DISCONTINUITY   (1 << 2) /* Discontinuity detected in the buffer */
#define APOLLO_BUFMGR_FLAG_PTS_VALID       (1 << 3) /* Valid PTS associated with the buffer */
#define APOLLO_BUFMGR_FLAG_DTS_VALID       (1 << 4) /* Valid DTS associated with the buffer */
...
{
    APOLLO_BUFMGR_OK                       = 0,
    APOLLO_BUFMGR_INVALID_HANDLE           = -1,
    APOLLO_BUFMGR_INVALID_PARAM            = -2,
    APOLLO_BUFMGR_INVALID_BUF_HANDLE       = -3,
    APOLLO_BUFMGR_SRCBUF_OUT_OF_RANGE      = -4,
    APOLLO_BUFMGR_MEM_ALLOC                = -5,
    APOLLO_BUFMGR_BUF_NOT_AVAIL            = -6,
    APOLLO_BUFMGR_BUF_HANDLE_NOT_AVAIL     = -7,
    APOLLO_BUFMGR_UNKNOWN_ERR              = -8
} apollo_bufmgr_status_t;
...
typedef void (*apollo_bufmgr_cb_t)(void *arg);
...
typedef struct apollo_bufmgr_buf_info_s
{
    struct apollo_bufmgr_buf_info_s *next;

    char    *buf;
    uint32_t reference_cnt;
    void    *subclass_private;
} apollo_bufmgr_buf_info_t;
...
typedef struct apollo_bufmgr_buf_handle_s
{
    struct apollo_bufmgr_buf_handle_s *next;

    objhandle_t               hpool;
    uint32_t                  offset;             /* Offset to start of valid data */
    uint32_t                  size;               /* Size of valid data in buffer  */
    apollo_bufmgr_buf_info_t *buf_info;
    uint32_t                  flags;
    mtimestamp_t              pts;
    mtimestamp_t              dts;
    void                     *subclass_private;
} apollo_bufmgr_buf_handle_t;
...
typedef struct
{
    ...
    apollo_bufmgr_cb_t callback;      /* Callback to notify when a buffer becomes available    */
    ...
    apollo_bufmgr_status_t (*register_cb)(objhandle_t hpool, apollo_bufmgr_cb_t callback, void *cb_arg);
    apollo_bufmgr_status_t (*alloc_buf)(objhandle_t hpool, objhandle_t *hbuf, char **buf, uint32_t *size, uint32_t timeout_ms);
    apollo_bufmgr_status_t (*free_buf)(objhandle_t hpool, objhandle_t hbuf);
    apollo_bufmgr_status_t (*dup_buf)(objhandle_t  hpool, objhandle_t hbuf, objhandle_t *hnewbuf, uint32_t offset, uint32_t size, uint32_t timeout_ms);
    apollo_bufmgr_status_t (*clone_buf)(objhandle_t hpool, objhandle_t hbuf, objhandle_t *hnewbuf, uint32_t offset, uint32_t size, uint32_t timeout_ms);
    apollo_bufmgr_status_t (*copy_buf)(objhandle_t hpool, objhandle_t hbuf, char *buf, uint32_t offset, uint32_t *num_bytes);
    ...
    apollo_bufmgr_status_t (*get_stats)(objhandle_t hpool, apollo_bufmgr_stats_t *stats);

    apollo_bufmgr_status_t (*set_buf_flags)(objhandle_t hpool, objhandle_t hbuf, uint32_t flags);
    uint32_t               (*get_buf_flags)(objhandle_t hpool, objhandle_t hbuf);
    apollo_bufmgr_status_t (*set_buf_pts)(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *pts);
    apollo_bufmgr_status_t (*get_buf_pts)(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *pts);
    apollo_bufmgr_status_t (*set_buf_dts)(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *dts);
    apollo_bufmgr_status_t (*get_buf_dts)(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *dts);

} apollo_bufmgr_pool_t;
 ...
 *
 * @return @ref apollo_bufmgr_status_t
 */
apollo_bufmgr_status_t apollo_bufmgr_pool_create(objhandle_t *hpool, char *name, uint32_t bufsize, uint32_t poolsize,
 ...
 * @return @ref apollo_bufmgr_status_t
 */
apollo_bufmgr_status_t apollo_bufmgr_pool_destroy(objhandle_t hpool);
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_register_cb(objhandle_t hpool, apollo_bufmgr_cb_t callback, void *cb_arg)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_alloc_buf(objhandle_t hpool, objhandle_t *hbuf, char **buf,
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_free_buf(objhandle_t hpool, objhandle_t hbuf)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_dup_buf(objhandle_t hpool, objhandle_t hbuf, objhandle_t *hnewbuf,
 ...
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_clone_buf(objhandle_t hpool, objhandle_t hbuf, objhandle_t *hnewbuf,
                                                                  uint32_t offset, uint32_t size, uint32_t timeout_ms)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_copy_buf(objhandle_t hpool, objhandle_t hbuf, char *dst_buf,
 ...
 */
static inline uint32_t apollo_bufmgr_pool_get_poolsize(objhandle_t hpool)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 */
static inline uint32_t apollo_bufmgr_pool_get_handle_poolsize(objhandle_t hpool)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 */
static inline uint32_t apollo_bufmgr_pool_get_bufsize(objhandle_t hpool)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 */
static inline uint32_t apollo_bufmgr_pool_get_actual_bufsize(objhandle_t hpool)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_get_stats(objhandle_t hpool, apollo_bufmgr_stats_t *stats)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_set_buf_flags(objhandle_t hpool, objhandle_t hbuf, uint32_t flags)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 */
static inline uint32_t apollo_bufmgr_pool_get_buf_flags(objhandle_t hpool, objhandle_t hbuf)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_set_buf_pts(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *pts)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_get_buf_pts(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *pts)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_set_buf_dts(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *dts)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
 ...
 * @return @ref apollo_bufmgr_status_t
 */
static inline apollo_bufmgr_status_t apollo_bufmgr_pool_get_buf_dts(objhandle_t hpool, objhandle_t hbuf, mtimestamp_t *dts)
{
    apollo_bufmgr_pool_t *pool = (apollo_bufmgr_pool_t *)hpool;
...
apollo_bufmgr_status_t apollo_bufmgr_buf_free(objhandle_t hbuf);
apollo_bufmgr_status_t apollo_bufmgr_buf_dup(objhandle_t hbuf, objhandle_t *hnewbuf, uint32_t offset, uint32_t size, uint32_t timeout_ms);
apollo_bufmgr_status_t apollo_bufmgr_buf_clone(objhandle_t hbuf, objhandle_t *hnewbuf, uint32_t offset, uint32_t size, uint32_t timeout_ms);
apollo_bufmgr_status_t apollo_bufmgr_buf_copy(objhandle_t hbuf, char *dst_buf, uint32_t offset, uint32_t *num_bytes);
apollo_bufmgr_status_t apollo_bufmgr_buf_get_data(objhandle_t hbuf, char **data, uint32_t *size);
apollo_bufmgr_status_t apollo_bufmgr_buf_adjust_offset(objhandle_t hbuf, uint32_t offset);
apollo_bufmgr_status_t apollo_bufmgr_buf_set_size(objhandle_t hbuf, uint32_t size);
uint32_t               apollo_bufmgr_buf_get_size(objhandle_t hbuf);
apollo_bufmgr_status_t apollo_bufmgr_buf_get_hdr(objhandle_t hbuf, char **header);
apollo_bufmgr_status_t apollo_bufmgr_buf_get_tail(objhandle_t hbuf, char **trailer);
apollo_bufmgr_status_t apollo_bufmgr_buf_set_flags(objhandle_t hbuf, uint32_t flags);
uint32_t               apollo_bufmgr_buf_get_flags(objhandle_t hbuf);
apollo_bufmgr_status_t apollo_bufmgr_buf_set_pts(objhandle_t hbuf, mtimestamp_t *pts);
apollo_bufmgr_status_t apollo_bufmgr_buf_get_pts(objhandle_t hbuf, mtimestamp_t *pts);
apollo_bufmgr_status_t apollo_bufmgr_buf_set_dts(objhandle_t hbuf, mtimestamp_t *dts);
apollo_bufmgr_status_t apollo_bufmgr_buf_get_dts(objhandle_t hbuf, mtimestamp_t *dts);
