...
/* Macros */
#if ARM_MATH == 1
    #define MPY_32_16( x32, y16 ) (Word32) ( ( (__int64) ( x32 ) * (__int64) ( y16 ) ) >> 15 )
#else
...
struct LCPLC_State
{
    ...
    short                  MusicClassHist;
};



/* Prototypes */
int LC_PLC_erasure( struct LCPLC_State* plc_state, Word16* out, Word16* CodecRingBuf,
                    Word16 zirl, Word16 PlcMethod, Word16 CodecConfig );
int LC_PLC( struct LCPLC_State* plc_state, Word16* in, Word16* out, Word16 nzsr, Word16 PlcMethod, Word16 CodecConfig );
int Init_LC_PLC( struct LCPLC_State* plc_state, int sf, int frmsz );
