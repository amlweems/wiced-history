...
wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .device_name               = (uint8_t *)"Apollo",               /**< Local device name (NULL terminated) */
    .device_class              = {0x24, 0x04, 0x18},                /**< Local device name (NULL terminated) */
    ...
    .max_simultaneous_links    = 6,/*TBD*/                          /**< Maximum number simultaneous links to different devices */
    ...
    /* GATT configuration */
            ...
            /* rpa_refresh_timeout > 0 enables privacy ( random address refreshing rate in seconds ) */
            .rpa_refresh_timeout = 900,
};
