...
/* Include the NetX API or the FileX stub API in cases where FileX is not
   available.  */
...
#define UX_HOST_CLASS_ASIX_NX_BUFF_SIZE                     (UX_HOST_CLASS_ASIX_ETHERNET_PACKET_SIZE + sizeof(NX_PACKET) + UX_HOST_CLASS_ASIX_NX_ALIGN_PADDING)
...
VOID  _ux_host_class_asix_driver_entry(NX_IP_DRIVER *nx_ip_driver);
...
VOID  _ux_host_class_asix_transfer_request_completed(UX_TRANSFER *transfer_request);
UINT  _ux_host_class_asix_reception_stop (UX_HOST_CLASS_ASIX *asix, 
                                    UX_HOST_CLASS_ASIX_RECEPTION *asix_reception);
UINT  _ux_host_class_asix_reception_start (UX_HOST_CLASS_ASIX *asix, 
                                    UX_HOST_CLASS_ASIX_RECEPTION *asix_reception);
