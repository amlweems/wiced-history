...
/*  05-28-2008     TCRG                     Modified comment(s),          */ 
/*                                            resulting in  version 5.2   */ 
/*  07-10-2009     TCRG                     Modified comment(s), added a  */ 
/*                                            mutex to protect            */ 
/*                                            queuing/dequeing of packets */ 
/*                                            between the application and */ 
/*                                            the RNDIS xmit thread, and  */ 
/*                                            added trace logic,          */ 
...
#define UX_DEVICE_CLASS_RNDIS_MAX_CONTROL_RESPONSE_LENGTH                       256
...
#define UX_DEVICE_CLASS_RNDIS_NX_BUFF_SIZE                                      (UX_DEVICE_CLASS_RNDIS_ETHERNET_PACKET_SIZE + sizeof(NX_PACKET) + UX_DEVICE_CLASS_RNDIS_NX_ALIGN_PADDING)
...
VOID  _ux_device_class_rndis_control_request(UX_SLAVE_CLASS_COMMAND *command);
...
VOID  _ux_device_class_rndis_driver_entry(NX_IP_DRIVER *nx_ip_driver);
