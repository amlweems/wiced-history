...
#define UX_MAX_ISO_TD                                       64 //1 //#BRCM#: Enlarge ISO TD limit to get ISO transfer running
...
#define UX_HOST_CLASS_STORAGE_MAX_TRANSFER_SIZE             (1024 * 64)
/* --- #BRCM#WICED#: WICED use, modified by JustinLi, 07/24/2015. */

/* Defined, this values include or exclude the interrupt tree for host controllers.
*/
