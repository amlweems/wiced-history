...
/*******************************************************************************
**
** Function         NFC_SetHalStatusCback
**
** Description      This function is called to set callback function
**                  to receive status of BRCM HAL API
**
** Parameters       p_status_cback - callback function
**
** Returns          Nothing
**
*******************************************************************************/
NFC_API extern void NFC_SetHalStatusCback (tNFC_STATUS_CBACK *p_status_cback);
#endif
