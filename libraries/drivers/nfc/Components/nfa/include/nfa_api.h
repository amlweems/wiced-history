...
#if (NFC_BRCM_NOT_OPEN_INCLUDED == TRUE)
#define NFA_DM_SNOOZE_MODE_EVT          8   /* Result of NFA_SetSnoozeMode      */
#define NFA_DM_UART_BAUD_RATE_EVT       9   /* Result of NFA_SetUartBaudRate    */
#endif
...
typedef struct
{
    tNFA_STATUS status;             /* Status of NDEF Validation            */
...
/* BRCM NFCC power mode */
#define NFA_BRCM_PWR_MODE_FULL    NFA_DM_PWR_MODE_FULL
#define NFA_BRCM_PWR_MODE_CE4     0x03
#define NFA_BRCM_PWR_MODE_CE3     0x02
#define NFA_BRCM_PWR_MODE_CE2     0x01
typedef UINT8 tNFA_BRCM_PWR_MODE;

/* bits of POWER_LEVEL VSC CE3Param byte */
#define NFA_BRCM_LP_PARAM_SWITCH_OFF    0x01    /* Switch Off mode enable/disable */
#define NFA_BRCM_LP_PARAM_BAT_MON       0x04    /* FW VBAT Monitor enable/disable */

#define NCI_PARAM_SIZE_POWER_LEVEL      0x06
#define NCI_PARAM_SIZE_SET_VBAT_MONITOR 0x03

#define NFA_SNOOZE_MODE_NONE      NFC_SNOOZE_MODE_NONE      /* Snooze mode disabled    */
#define NFA_SNOOZE_MODE_UART      NFC_SNOOZE_MODE_UART      /* Snooze mode for UART    */
#define NFA_SNOOZE_MODE_SPI_I2C   NFC_SNOOZE_MODE_SPI_I2C   /* Snooze mode for SPI/I2C */

#define NFA_SNOOZE_ACTIVE_LOW     NFC_SNOOZE_ACTIVE_LOW     /* high to low voltage is asserting */
#define NFA_SNOOZE_ACTIVE_HIGH    NFC_SNOOZE_ACTIVE_HIGH    /* low to high voltage is asserting */
...
/*******************************************************************************
**
** Function         NFA_SetPowerMode
**
** Description      This function is called to set power mode of NFCC
**                  NFA_DM_PWR_MODE_CHANGE_EVT will be sent to indicate status.
**
**                  power_mode : NFA_BRCM_PWR_MODE_FULL
**                               NFA_BRCM_PWR_MODE_CE4
**                               NFA_BRCM_PWR_MODE_CE3
**                               NFA_BRCM_PWR_MODE_CE2
**                  
**                  ce_tech_mask : available listen technologies in CE low power mode
**                  
**                  force: FALSE - NFCC may reject the command (e.g. if link is activated)
**                         TRUE  - NFCC will enter the power level as instructed.
**                  
**                  Listen mode routing table indicates which NFCEE host's configuration
**                  to be used in CE low power mode.
**
** Returns          NFA_STATUS_OK if successfully initiated
**                  NFA_STATUS_FAILED otherwise
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_SetPowerMode (tNFA_BRCM_PWR_MODE   power_mode,
                                             tNFA_TECHNOLOGY_MASK ce_tech_mask,
                                             BOOLEAN              force);

/*******************************************************************************
**
** Function         NFA_SetSnoozeMode
**
** Description      This function is called to set snooze mode of NFCC
**                  NFA_DM_SNOOZE_MODE_EVT will be sent to indicate status.
**
**                  snooze_mode : NFA_SNOOZE_MODE_NONE
**                                NFA_SNOOZE_MODE_UART
**                                NFA_SNOOZE_MODE_SPI_I2C
**                  
...
**                   - nfc_wake_active_mode: NFA_SNOOZE_ACTIVE_LOW or NFA_SNOOZE_ACTIVE_HIGH
**                   - dh_wake_active_mode:  NFA_SNOOZE_ACTIVE_LOW or NFA_SNOOZE_ACTIVE_HIGH
**                  
**
** Returns          NFA_STATUS_OK if successfully initiated
**                  NFA_STATUS_FAILED otherwise
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_SetSnoozeMode (UINT8 snooze_mode,
...
/*******************************************************************************
**
** Function         NFA_SetUartBaudRate
**
** Description      This function is called to set UART baud rate of NFCC
**                  NFA_DM_UART_BAUD_RATE_EVT will be sent to indicate status.
**
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_SetUartBaudRate (UINT8 baud_rate_index);
