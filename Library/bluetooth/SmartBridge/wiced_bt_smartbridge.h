 ...
 */
typedef wiced_result_t (*wiced_bt_smartbridge_pairing_callback_t)      ( wiced_bt_smartbridge_socket_t* socket, const wiced_bt_smart_bond_info_t* bond_info );
...
struct wiced_bt_smartbridge_socket
{
    ...
    wiced_bt_smartbridge_pairing_callback_t       pairing_callback;               /**< Callback for handling pairing/bonding successful event        */
 ...
 * @param[in]      settings         : security settings
 * @param[in]      pairing_callback : callback that is called when pairing is successful
 *
 * @note:
 *
 * @return @ref wiced_result_t
...
wiced_result_t wiced_bt_smartbridge_enable_pairing( wiced_bt_smartbridge_socket_t*            socket,
                                                    const wiced_bt_smart_security_settings_t* settings,
                                                    wiced_bt_smartbridge_pairing_callback_t   pairing_callback );
