...
char*        dns_read_name             (uint8_t* data, dns_message_header_t* start_of_packet); // Note: This function returns a dynamically allocated string
...
char*        dns_convert_name_to_string(dns_name_t* name); // Note: This function returns a dynamically allocated string
