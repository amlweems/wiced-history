...
extern void           gedday_init            ( wiced_interface_t interface, char* desired_name );
extern wiced_result_t gedday_discover_service( char* service_query, gedday_service_t* service_result );
