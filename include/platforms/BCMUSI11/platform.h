...
/*
BCMUSI11 platform pin definitions ...
+----------------------------------------------------------------------------------------+
...
+----------------------------------------------------------------------------------------+
Notes
1. These mappings are defined in <WICED-SDK>/Platform/BCMUSI11/platform.c
...
typedef enum
{
    ...
    WICED_GPIO_FORCE_32_BIT = 0x7FFFFFFF,
...
typedef enum
{
    ...
    WICED_SPI_FORCE_32_BIT = 0x7FFFFFFF,
...
typedef enum
{
    ...
    WICED_I2C_FORCE_32_BIT = 0x7FFFFFFF,
 ...
 * 2. MCO (MCU Clock Output). A hardware patch is needed on the BCM9WCDPLUS1 eval board to enable this mode as follows:
 *    - Connect TP16 to Pin 20 of J11 (expansion header). This patch connects STM32F205RGY6 pin E2 (PA8) to pin G2 (PC6)
