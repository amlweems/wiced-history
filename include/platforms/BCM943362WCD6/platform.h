...
+---------------+----+------------------+------+---------------+-------------+--------------+-------------+
Notes
1. These mappings are defined in <WICED-SDK>/Platform/BCM943362WCD6/platform.c
2. STM32F4xx Datasheet  -> http://www.st.com/internet/com/TECHNICAL_RESOURCES/TECHNICAL_LITERATURE/DATASHEET/DM00037051.pdf
3. STM32F4xx Ref Manual -> http://www.st.com/internet/com/TECHNICAL_RESOURCES/TECHNICAL_LITERATURE/REFERENCE_MANUAL/DM00031020.pdf
*/
 ...
 * 2. MCO (MCU Clock Output). A hardware patch is needed on the BCM943362WCD6 module to enable this mode as follows:
