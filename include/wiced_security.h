 ...
 */
void aes_setkey_enc( aes_context_t *ctx, unsigned char *key, int32_t keysize );
 ...
 * @param keysize  must be 128, 192 or 256
 */
void aes_setkey_dec( aes_context_t *ctx, unsigned char *key, int32_t keysize );
 ...
 */
void aes_crypt_ecb( aes_context_t *ctx, int32_t mode, unsigned char input[16], unsigned char output[16] );
 ...
 */
void aes_crypt_cbc( aes_context_t *ctx, int32_t mode, int32_t length, unsigned char iv[16], unsigned char *input, unsigned char *output );
 ...
 * @param output   buffer holding the output data
 */
void aes_crypt_cfb128( aes_context_t *ctx, int32_t mode, int32_t length, int32_t *iv_off, unsigned char iv[16], unsigned char *input, unsigned char *output );
